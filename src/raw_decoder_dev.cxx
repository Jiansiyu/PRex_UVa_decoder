...
map<int, TH1F* > RawDecoder::DrawRawHisto(TCanvas *c,TCanvas *c0, TCanvas *c1,TCanvas *c2,TCanvas *c3, TCanvas *c4,TCanvas *c5,TCanvas *c6,TCanvas *c7, TCanvas *c8, TCanvas *c9, TCanvas *c10, TCanvas *c11) {
  int mpd_id=0;
  int adc_ch=0;
  int hybridID=0;
  ...
  for(itRaw = mAPVRawHisto.begin(); itRaw!=mAPVRawHisto.end(); itRaw++) {
    ...
    cout<<"histoname: "<<itRaw->second->GetName()<<"  histoID: "<<histnameToAPVIDmap[itRaw->second->GetName()]<<endl;
