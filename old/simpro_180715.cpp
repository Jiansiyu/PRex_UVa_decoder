...
void simpro(TString ifi0, TString ifi1="", TString ifi2="") {
  ...
  TH1F *hcx = new TH1F("hcx","Single x-Strip Charge", 100, 0, 5000);
  hcx->SetLineColor(2);
  hcx->SetXTitle("Charge");
  TH1F *hcy = new TH1F("hcy","Single y-Strip Charge", 100, 0, 5000);
  hcy->SetLineColor(4);
  hcy->SetXTitle("Charge");
      
  TH2F *h2 = new TH2F("h2","x / y cross corr",1024,-0.5,1023.5,1280,-0.5,1279.5);
  ...
  for (Int_t i=0;i<nn;i++) {
	...
	h2->Fill(strip[ix[jx]], strip[iy[jy]], xcor(ax, ay));
